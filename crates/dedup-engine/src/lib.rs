...
pub use keepset::{
    ...
    group_candidates_with_stats, is_attach_incomplete, multi_input_source_rank_hint, rank_key,
    reason_fidelity_tier, recoverable_items_hint, resolve_groups, resolve_groups_with_ctx,
    resolve_groups_with_grouping, resolve_item_date, segment_glob_match, sort_input_paths,
    source_rank_of, write_keep_set_json, CanonicalAttachment, CanonicalMessage, DateSource,
    DecisionCsvWriter, DecisionRecord, DecisionRole, FamilyPolicy, FidelityMode, FolderClass,
    FolderRankMode, GroupingOutcome, KeepEntry, KeepPolicy, KeepSet, KeepSetError,
    KeepSetProvenance, KeepSetStats, MaterializeBuildOpts, MaterializeError,
    MaterializeFinalizeOpts, MessageLocus, MessageMaterializer, NestedCanonicalMessage,
    NestedExtractFail, PromoteReason, RankContext, RankKey, RecoverableScanItem, ResolvedKeepSet,
