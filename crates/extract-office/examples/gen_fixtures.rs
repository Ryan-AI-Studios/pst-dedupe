...
fn main() {
    let root = Path::new("fixtures/office");
    std::fs::create_dir_all(root).unwrap();

    let content_types_docx = r#"<?xml version="1.0" encoding="UTF-8" standalone="yes"?>
...
<w:document xmlns:w="http://schemas.openxmlformats.org/wordprocessingml/2006/main">
  <w:body>
    <w:p><w:r><w:t>OFFICE_DOCX_MARKER</w:t></w:r></w:p>
  </w:body>
</w:document>"#;
    write_zip(
        &root.join("minimal.docx"),
        &[
    ...
    let content_types_xlsx = r#"<?xml version="1.0" encoding="UTF-8" standalone="yes"?>
<Types xmlns="http://schemas.openxmlformats.org/package/2006/content-types">
  <Default Extension="rels" ContentType="application/vnd.openxmlformats-package.relationships+xml"/>
  <Default Extension="xml" ContentType="application/xml"/>
  ...
  <Override PartName="/xl/styles.xml" ContentType="application/vnd.openxmlformats-officedocument.spreadsheetml.styles+xml"/>
    ...
    let rels_xlsx = r#"<?xml version="1.0" encoding="UTF-8" standalone="yes"?>
<Relationships xmlns="http://schemas.openxmlformats.org/package/2006/relationships">
...
<styleSheet xmlns="http://schemas.openxmlformats.org/spreadsheetml/2006/main">
  ...
  <cellXfs count="1"><xf numFmtId="0" fontId="0" fillId="0" borderId="0" xfId="0"/></cellXfs>
    ...
    let content_types_pptx = r#"<?xml version="1.0" encoding="UTF-8" standalone="yes"?>
<Types xmlns="http://schemas.openxmlformats.org/package/2006/content-types">
  <Default Extension="rels" ContentType="application/vnd.openxmlformats-package.relationships+xml"/>
  <Default Extension="xml" ContentType="application/xml"/>
  ...
  <Override PartName="/ppt/slides/slide1.xml" ContentType="application/vnd.openxmlformats-officedocument.presentationml.slide+xml"/>
    ...
    let rels_pptx = r#"<?xml version="1.0" encoding="UTF-8" standalone="yes"?>
<Relationships xmlns="http://schemas.openxmlformats.org/package/2006/relationships">
...
<p:sld xmlns:a="http://schemas.openxmlformats.org/drawingml/2006/main"
 xmlns:p="http://schemas.openxmlformats.org/presentationml/2006/main">
  ...
  <p:clrMapOvr><a:masterClrMapping/></p:clrMapOvr>
    ...
    std::fs::write(
        root.join("corrupt.docx"),
        b"PK\x03\x04not-a-real-zip-payload",
    )
    .unwrap();
    let mut ole = vec![0u8; 64];
    ole[0..8].copy_from_slice(&[0xD0, 0xCF, 0x11, 0xE0, 0xA1, 0xB1, 0x1A, 0xE1]);
    std::fs::write(root.join("legacy.doc"), &ole).unwrap();
