...
From `C:\dev\deviations.md` vs `C:\dev\dedupe-frontend` (research only). **0123 Completed**. **0124 Completed**. **0125 Completed**. Expand **0126** with `/plan-track`. Do not steal 0119–0122 Bugbot. **0123 locks (2026-09-01):** Plex + ink-navy `#1b3049` (blue theme); Home under the shared bar. Do not port Archivo/coral.
