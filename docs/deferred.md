...
| D-0121-image-opt-qc | P3 | PR #121 Bugbot: OPT-missing resume; QC all volumes; JPEG eligibility vs sniff; TIFF magic vs MIME | Valid; matter-qc / pdf-raster / matter-produce. Do not steal into 0116. Ready spec 2026-09-01; fold-in intersection guard + delete unused QC magic helpers. | **0121** Ready — not started |
