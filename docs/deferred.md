...
| D-0131-recoverable-items-operator-hint | — | 826/4055 winners from Recoverable Items / Purges | **Closed in 0131** (PR **#147** / `9082761`) — runbook opt-in `--prefer-folder-class`. HITL 2026-09-03: RI **826 → 821** (five groups had a live peer). | **closed / 0131** |
