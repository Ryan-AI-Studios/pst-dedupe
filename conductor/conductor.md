...
**Timing (2026-09-01):** unique-export Series S is closed. **0110 Completed** (PR **#111** / `5a76f0b`). **0111 Completed** (PR **#113** / `3c4ca65`). **0112 Completed** (PR **#115** / `81a3aad`). **0113 Completed** (PR **#117** / `f192b2d`). **0114 Completed** (PR **#119** / `5ed53bf`). **0115 Completed** (PR **#121** / `19d0c1f`). **0116 Completed** (PR **#123** / `727c857`). **0117 Completed** (PR **#125** / `199975c`). **0118 Completed** (PR **#127** / `74fd797`). **0119 Completed** (PR **#129** / `6a775b5`). **0120 Completed** (PR **#131** / `e87f4c1`). **0121 Completed** (PR **#135** / `600d6b3`). **0122 Completed** (PR **#137** / `f1810fe`). **0123 Completed** (PR **#139** / `fce416e`). **0124 Ready — not started** (queue chrome: ellipsis first; 244px rail; Go-to + row range in 0123 slots). **0125–0126 Proposed**. Do not remint IDs. Do not vendor `C:\dev\dedupe-frontend`.
...
**Suggested order:** **0110** → **0111** → **0112** → **0113**; **0114** after window; **0115 Completed**; **0116 Completed** (Process last on the spine). **0117 Completed** (queue Bugbot). **0118 Completed** (window async). **0119 Completed** (produce honesty). **0120 Completed** (raster UI honesty). **0121 Completed** (image QC honesty). **0122 Completed** (Process extract-all / orphan). **0123 Completed** (shell). **0124 Ready** (queue chrome) → **0125** produce canvas and **0126** Process visual can run in parallel after 0123.

## Series T — Mockup chrome fidelity (post-0122)

Bugbot residuals **0120–0122** stay their own tracks. These IDs steal **layout** from `C:\dev\dedupe-frontend` (research only). **0123 Completed**. **0124 Ready — not started**. Expand **0125–0126** with `/plan-track` before Implement. **0123 tokens locked 2026-09-01:** Plex + ink-navy `#1b3049` (blue theme); Home under the shared bar. Do not port Archivo/coral.
...
| [0124-ReviewQueueChrome](0124-ReviewQueueChrome/spec.md) | **In progress** | 244px rail, toolbar, bulk, Go-to in 0123 right slot, SQL-page row range in status-left. **DoD-1 first:** cell ellipsis so X500 From never paints on Fam/Resp/PRIV. Control# = `review_order`; PRIV coding. No 0117 math rewrite. Fold-in 2026-09-01: `QueueChromeCtx` + mount/resize `viewport_h`. |
...
**Suggested order:** **0122 Completed**. **0123 Completed** (shell). **0124 Ready** (queue chrome) → **0125** produce canvas and **0126** Process visual can run in parallel after 0123.
