...
**Timing (2026-08-31):** unique-export Series S is closed. **0110 Completed** (PR **#111** / `5a76f0b`). **0111 Completed** (PR **#113** / `3c4ca65`). **0112 Completed** (PR **#115** / `81a3aad`). **0113 Completed** (PR **#117** / `f192b2d`). **0114 Completed** (PR **#119** / `5ed53bf`). **0115 Completed** (PR **#121** / `19d0c1f`). **0116 Completed** (PR **#123** / `727c857`). **0117 Completed** (PR **#125** / `199975c`). **0118 Completed** (PR **#127** / `74fd797`). **0119** Proposed (PR #117 produce Bugbot + PR #123 cancelled-produce). **0120** Proposed (PR #119 raster UI Bugbot). **0121** Proposed (PR #121 image QC Bugbot). **0122** Proposed (PR #123 Process Bugbot). Do not remint IDs. Do not vendor `C:\dev\dedupe-frontend`.
...
| [0119-ProduceChecklistResiduals](0119-ProduceChecklistResiduals/spec.md) | **Proposed — placeholder** | PR **#117** Bugbot: Finalize re-arm, empty privilege-log `filter_ids`, QC state across matters. Plus PR **#123** cancelled-produce-as-success. Not raster. |
| [0120-PdfRasterUiResiduals](0120-PdfRasterUiResiduals/spec.md) | **Proposed — placeholder** | PR **#119** Bugbot: overlay mouseup coords, draw state across pages, stale Burn counts. Not OPT. |
...
**Suggested order:** **0110** → **0111** → **0112** → **0113**; **0114** after window; **0115 Completed**; **0116 Completed** (Process last on the spine). **0117 Completed** (queue Bugbot). **0118 Completed** (window async). **0119** can follow 0113 without blocking 0114. **0120** can follow 0114 without blocking 0115. **0121** can follow 0115 without blocking 0116. **0122** can follow 0116 without blocking 0117.
