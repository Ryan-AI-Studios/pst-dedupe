...
| [0125-ProduceCanvas](0125-ProduceCanvas/spec.md) | **In progress** | Un-wizard: five steps visible + protocol + 320px Stage. Finalize moves to Stage; **0119** latch frozen. Privilege-in-set unchanged. No fake snapshot / ACME Bates. Fold-in 2026-09-01: pad on Thin, no mount auto-QC, ui `serde(default)`. |
...
**Suggested order:** **0122 Completed**. **0123 Completed** (shell). **0124 Completed** (queue chrome). **0125 In progress** (produce canvas) and **0126** Process visual can run in parallel after 0123.
