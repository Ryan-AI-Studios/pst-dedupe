...
**Suggested order:** **0122 Completed**. **0123 Completed** (shell). **0124 Completed** (queue chrome) → **0125** produce canvas and **0126** Process visual can run in parallel after 0123.
