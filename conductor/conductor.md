...
|---|---|---|---|---|
| 001 | Planned | Infra | Make workspace compile and establish baseline Cargo/ChangeGuard gates. | Current known blockers: GUI `Debug` derive issue, pst-reader permute crypto test failure. |
