...
**Suggested order:** **0110** → **0111** → **0112** → **0113**; **0114** after window; **0115 Completed**; **0116 Completed** (Process last on the spine). **0117 Completed** (queue Bugbot). **0118 Completed** (window async). **0119 Completed** (produce honesty). **0120 Completed** (raster UI honesty). **0121 Completed** (image QC honesty). **0122** can follow 0116 without blocking 0117. Then **0123** shell (Plex + navy; Home under bar) → **0124** queue → **0125** produce canvas and **0126** Process visual can run in parallel after 0123.
...
**Suggested order:** **0122** Bugbot after or in parallel where they do not share files. Then **0123** shell → **0124** queue → **0125** produce canvas and **0126** Process visual can run in parallel after 0123.
