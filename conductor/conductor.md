...
| [0118-ReviewWindowAsyncResiduals](0118-ReviewWindowAsyncResiduals/spec.md) | **In Progress** | PR **#115** Bugbot: stale document/body fetch; post-save snapshot; unused path_id `#[test]`. Fold-in 2026-08-31 (did-not-navigate refresh; catalog gated). Not produce. |
...
**Suggested order:** **0110** → **0111** → **0112** → **0113**; **0114** after window; **0115 Completed**; **0116 Completed** (Process last on the spine). **0117 Completed** (queue Bugbot). **0118 Ready** (window async). **0119** can follow 0113 without blocking 0114. **0120** can follow 0114 without blocking 0115. **0121** can follow 0115 without blocking 0116. **0122** can follow 0116 without blocking 0117.
