...
**Timing (2026-08-30):** unique-export Series S is closed. **0110 Completed** (PR **#111** / `5a76f0b`). **0111 Completed** (PR **#113** / `3c4ca65`). **0112 Completed** (PR **#115** / `81a3aad`). **0113 Completed** (PR **#117** / `f192b2d`). **0114 Completed** (PR **#119** / `5ed53bf`). **0115 Ready** (TIFF G4 + OPT; un-parked). **0116** Proposed. **0117** Proposed (PR #113 queue Bugbot). **0118** Proposed (PR #115 window Bugbot). **0119** Proposed (PR #117 produce Bugbot). **0120** Proposed (PR #119 raster UI Bugbot). Do not remint IDs. Do not vendor `C:\dev\dedupe-frontend`.

**Stack lock:** Tauri 2 + Leptos, Plex/paper/cool chrome, keep egui Process until **0116**. One pipeline. No daemon. Image/OPT **0115** Ready (opt-in profile; default DAT-only stays). Search builder folds into **0111** (no extra search-builder ID). **0117** is PR #113 queue Bugbot, not search. **0118** is PR #115 window async, not produce. **0119** is PR #117 produce wizard Bugbot, not raster. **0120** is PR #119 Image-tab/Burn-count Bugbot, not OPT. No BCC-default track.
...
| [0115-ImageOptFactory](0115-ImageOptFactory/spec.md) | **In Progress** | TIFF G4 + Opticon OPT; page-level Bates; builtin `us_concordance_image_opt_v1`. Default DAT-only unchanged. Schema **v41**. Closes **D-0040-01** / **D-0060-04** (LFP residual). |
...
**Suggested order:** **0110** → **0111** → **0112** → **0113**; **0114** after window; **0115** Ready (opt-in image factory); **0116** last. **0117** can follow 0111 without blocking 0112. **0118** can follow 0112 without blocking 0113. **0119** can follow 0113 without blocking 0114. **0120** can follow 0114 without blocking 0115.
