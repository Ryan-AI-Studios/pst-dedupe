...
**Timing (2026-08-30):** unique-export Series S is closed. **0110 Completed** (PR **#111** / `5a76f0b`). **0111 Completed** (PR **#113** / `3c4ca65`). **0112 Completed** (PR **#115** / `81a3aad`). 0113–0116 stay Proposed (0115 parked). **0117** Proposed (PR #113 queue Bugbot). Do not remint IDs. Do not vendor `C:\dev\dedupe-frontend`.

**Stack lock:** Tauri 2 + Leptos, Plex/paper/cool chrome, keep egui Process until **0116**. One pipeline. No daemon. Image/OPT **0115** parked until a produce needs images. Search builder folds into **0111** (no extra search-builder ID). **0117** is PR #113 queue Bugbot, not search. No BCC-default track.
...
**Suggested order:** **0110** → **0111** → **0112** → **0113**; **0114** after window; **0115** parked; **0116** last. **0117** can follow 0111 without blocking 0112. Do not skip to raster/OPT first.
