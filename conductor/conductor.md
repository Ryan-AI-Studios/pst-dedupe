...
**Timing (2026-08-30):** unique-export Series S is closed. **0110 Completed** (PR **#111** / `5a76f0b`). **0111 Completed** (PR **#113** / `3c4ca65`). **0112 In Progress**. 0113–0116 stay Proposed (0115 parked). **0117** Proposed (PR #113 queue Bugbot). Do not remint IDs. Do not vendor `C:\dev\dedupe-frontend`.
...
| [0112-ReviewWindow](0112-ReviewWindow/spec.md) | **In Progress** | Three-pane coding; Responsiveness ⊥ Privilege; Native/Text; Image stub. Closes **D-0112-review-window**. |
