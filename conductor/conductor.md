...
**Timing (2026-08-31):** unique-export Series S is closed. **0110 Completed** (PR **#111** / `5a76f0b`). **0111 Completed** (PR **#113** / `3c4ca65`). **0112 Completed** (PR **#115** / `81a3aad`). **0113 Completed** (PR **#117** / `f192b2d`). **0114 Completed** (PR **#119** / `5ed53bf`). **0115 Completed** (PR **#121** / `19d0c1f`). **0116 In Progress**. **0117** Proposed (PR #113 queue Bugbot). **0118** Proposed (PR #115 window Bugbot). **0119** Proposed (PR #117 produce Bugbot). **0120** Proposed (PR #119 raster UI Bugbot). **0121** Proposed (PR #121 image QC Bugbot). Do not remint IDs. Do not vendor `C:\dev\dedupe-frontend`.

**Stack lock:** Tauri 2 + Leptos, Plex/paper/cool chrome, keep egui Process until **0116**. One pipeline. No daemon. Image/OPT **0115 Completed** (opt-in profile; default DAT-only stays). Search builder folds into **0111** (no extra search-builder ID). **0117** is PR #113 queue Bugbot, not search. **0118** is PR #115 window async, not produce. **0119** is PR #117 produce wizard Bugbot, not raster. **0120** is PR #119 Image-tab/Burn-count Bugbot, not OPT. **0121** is PR #121 image QC/eligibility Bugbot, not Process. No BCC-default track.
...
| [0116-ProcessFold](0116-ProcessFold/spec.md) | **In Progress** | Swallow egui Process into the same Tauri window (`process-runner`); absorb D-0113-long-job. Fold-in 2026-08-31 (`opencode-review.md` + `agy-review.md`). |
...
**Suggested order:** **0110** → **0111** → **0112** → **0113**; **0114** after window; **0115 Completed**; **0116 Ready** (Process last on the spine). **0117** can follow 0111 without blocking 0112. **0118** can follow 0112 without blocking 0113. **0119** can follow 0113 without blocking 0114. **0120** can follow 0114 without blocking 0115. **0121** can follow 0115 without blocking 0116.
