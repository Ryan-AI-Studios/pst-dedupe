...
**Timing (2026-09-01):** unique-export Series S is closed. **0110 Completed** (PR **#111** / `5a76f0b`). **0111 Completed** (PR **#113** / `3c4ca65`). **0112 Completed** (PR **#115** / `81a3aad`). **0113 Completed** (PR **#117** / `f192b2d`). **0114 Completed** (PR **#119** / `5ed53bf`). **0115 Completed** (PR **#121** / `19d0c1f`). **0116 Completed** (PR **#123** / `727c857`). **0117 Completed** (PR **#125** / `199975c`). **0118 Completed** (PR **#127** / `74fd797`). **0119 Completed** (PR **#129** / `6a775b5`). **0120 Completed** (PR **#131** / `e87f4c1`). **0121** Ready — not started (PR #121 image QC Bugbot). **0122** Proposed (PR #123 Process Bugbot). **Series T 0123–0126 Proposed** (mockup chrome fidelity; 0123 tokens = Plex + ink-navy, Home under shared bar). Do not remint IDs. Do not vendor `C:\dev\dedupe-frontend`.
...
| [0121-ImageOptQcResiduals](0121-ImageOptQcResiduals/spec.md) | **Ready — not started** | PR **#121** Bugbot: OPT skip until complete, scoped image QC, JPEG eligibility, TIFF magic vs MIME. Not 0116. Not 0120 overlay. |
| [0122-ProcessFoldResiduals](0122-ProcessFoldResiduals/spec.md) | **Proposed — placeholder** | PR **#123** Bugbot: extract-all Busy wipes queue; live jobs painted as orphans. Not 0117. |

**Suggested order:** **0110** → **0111** → **0112** → **0113**; **0114** after window; **0115 Completed**; **0116 Completed** (Process last on the spine). **0117 Completed** (queue Bugbot). **0118 Completed** (window async). **0119 Completed** (produce honesty). **0120 Completed** (raster UI honesty). **0121 Ready — not started** (image QC honesty; can follow 0115). **0122** can follow 0116 without blocking 0117. Then **0123** shell (Plex + navy; Home under bar) → **0124** queue → **0125** produce canvas and **0126** Process visual can run in parallel after 0123.

## Series T — Mockup chrome fidelity (post-0122)

Bugbot residuals **0120–0122** stay their own tracks. These IDs steal **layout** from `C:\dev\dedupe-frontend` (research only). Expand with `/plan-track` before Implement. **0123 tokens locked 2026-09-01:** Plex + ink-navy `#1b3049` (blue theme); Home under the shared bar. Do not port Archivo/coral.

| Track | Status | Summary |
|---|---|---|
| [0123-MatterShell](0123-MatterShell/spec.md) | **Proposed — placeholder** | Shared TopBar + StatusBar; Home under the bar; Plex + ink-navy `#1b3049`. Admin inert; recents BOM. Not 0124 columns. |
| [0124-ReviewQueueChrome](0124-ReviewQueueChrome/spec.md) | **Proposed — placeholder** | 244px rail, toolbar, bulk, row range. **Column text must not collide** (ellipsis; 32px rows). Keep Control# / PRIV honesty. |
| [0125-ProduceCanvas](0125-ProduceCanvas/spec.md) | **Proposed — placeholder** | Un-wizard: five steps + protocol + Stage pane. 0119 Bugbot stays. Privilege-in-set unchanged. |
| [0126-ProcessChromeVisual](0126-ProcessChromeVisual/spec.md) | **Proposed — placeholder** | Jobs table, locked profile, drop copy, minus-stack. Absorb D-0116-report if cheap. **0122** Bugbot stays. |

**Suggested order:** **0121–0122** Bugbot after or in parallel where they do not share files. Then **0123** shell → **0124** queue → **0125** produce canvas and **0126** Process visual can run in parallel after 0123.
