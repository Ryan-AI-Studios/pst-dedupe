...
**Suggested order:** **0110** → **0111** → **0112** → **0113**; **0114** after window; **0115 Completed**; **0116 Completed** (Process last on the spine). **0117 Completed** (queue Bugbot). **0118 Completed** (window async). **0119 Completed** (produce honesty). **0120 Completed** (raster UI honesty). **0121 Completed** (image QC honesty). **0122 Completed** (Process extract-all / orphan). **0123 Completed** (shell). **0124 Completed** (queue chrome). **0125 Completed** (produce canvas). **0126 In progress** (Process visual).

## Series T — Mockup chrome fidelity (post-0122)

Bugbot residuals **0120–0122** stay their own tracks. These IDs steal **layout** from `C:\dev\dedupe-frontend` (research only). **0123 Completed**. **0124 Completed**. **0125 Completed**. **0126 In progress**. **0123 tokens locked 2026-09-01:** Plex + ink-navy `#1b3049` (blue theme); Home under the shared bar. Do not port Archivo/coral.
...
| [0126-ProcessChromeVisual](0126-ProcessChromeVisual/spec.md) | **In progress** | Jobs table (job grain; per-row Dupes/NIST stay `—`), locked builtin checklist, honest drop copy, `\\?\` strip, minus-stack, 0039 download. **0122** Busy frozen. Fold-in 2026-09-02: no OST/MBOX copy; Tauri capability wire. |

**Suggested order:** **0122 Completed**. **0123 Completed** (shell). **0124 Completed** (queue chrome). **0125 Completed** (produce canvas). **0126 In progress** (Process visual).
