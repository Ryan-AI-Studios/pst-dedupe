...
**Timing (2026-08-30):** unique-export Series S is closed. **0110 Completed** (PR **#111** / `5a76f0b`). **0111 Completed** (PR **#113** / `3c4ca65`). **0112 Completed** (PR **#115** / `81a3aad`). **0113 Completed** (PR **#117** / `f192b2d`). **0114 In progress** (zpdf raster + geometric burn). 0115 parked. **0116** Proposed. **0117** Proposed (PR #113 queue Bugbot). **0118** Proposed (PR #115 window Bugbot). **0119** Proposed (PR #117 produce Bugbot). Do not remint IDs. Do not vendor `C:\dev\dedupe-frontend`.
...
| [0114-PdfRasterRedact](0114-PdfRasterRedact/spec.md) | **In progress** | `zpdf` CPU raster + geometric draft boxes + content-stream burn then rewrite. Schema **v40**. Closes **D-0032-01** / **D-0034-02**. pdfium sidecar optional residual. |
