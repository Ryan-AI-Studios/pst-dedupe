...
| [0117-QueueVirtualizationResiduals](0117-QueueVirtualizationResiduals/spec.md) | **In Progress** | PR **#113** Bugbot: queue header/spacer, empty-page vacant lie, arrow `scroll_top`. Fold-in 2026-08-31 (`opencode-review.md` + `agy-review.md`). |
| [0118-ReviewWindowAsyncResiduals](0118-ReviewWindowAsyncResiduals/spec.md) | **Proposed — placeholder** | PR **#115** Bugbot: stale document/body fetch; post-save snapshot; unused path_id `#[test]`. Not produce. |
...
**Suggested order:** **0110** → **0111** → **0112** → **0113**; **0114** after window; **0115 Completed**; **0116 Completed** (Process last on the spine). **0117 Ready** (queue Bugbot; can follow 0111). **0118** can follow 0112 without blocking 0113. **0119** can follow 0113 without blocking 0114. **0120** can follow 0114 without blocking 0115. **0121** can follow 0115 without blocking 0116. **0122** can follow 0116 without blocking 0117.
