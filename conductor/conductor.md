...
**Timing (2026-08-31):** unique-export Series S is closed. **0110 Completed** (PR **#111** / `5a76f0b`). **0111 Completed** (PR **#113** / `3c4ca65`). **0112 Completed** (PR **#115** / `81a3aad`). **0113 Completed** (PR **#117** / `f192b2d`). **0114 Completed** (PR **#119** / `5ed53bf`). **0115 Completed** (PR **#121** / `19d0c1f`). **0116** Proposed. **0117** Proposed (PR #113 queue Bugbot). **0118** Proposed (PR #115 window Bugbot). **0119** Proposed (PR #117 produce Bugbot). **0120** Proposed (PR #119 raster UI Bugbot). Do not remint IDs. Do not vendor `C:\dev\dedupe-frontend`.
...
**Suggested order:** **0110** → **0111** → **0112** → **0113**; **0114** after window; **0115 Completed**; **0116** last. **0117** can follow 0111 without blocking 0112. **0118** can follow 0112 without blocking 0113. **0119** can follow 0113 without blocking 0114. **0120** can follow 0114 without blocking 0115.
