...
- **Branch:** `track/0101-embedded-depth-flag` (pruned after squash-merge)
- **Status:** **Completed**
- **HITL:** **skipped** — no operator INC* `--max-embedded-depth 8` smoke this pass (`D-0094-inc-resmoke` remains residual)
- **PR / SHA:** [#92](https://github.com/Ryan-AI-Studios/pst-dedupe/pull/92) / `4bbf620`
...
| **DoD-4 Recorded** | **PASS** | This file; PR **#92** `4bbf620`; ledger FEATURE on `crates/pst-dedup-cli` (tx linked at commit); `D-0067-embedded-depth` narrowed (CLI shipped, **not closed**); HITL skipped as above. |
