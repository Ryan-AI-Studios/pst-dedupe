...
- **Plan-of-record reference:** `C:\dev\Dedupe-plan.md` → Series A / track 0020
...
Single-exe friendly UI: create matter, add sources, run process, show progress—no servers.
...
1. Deliver the capability summarized in §1 for Series A.
