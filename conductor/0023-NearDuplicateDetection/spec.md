# 0023 — Near-duplicate detection

- **Track ID:** 0023-NearDuplicateDetection
- **Execution repo:** `C:\dev\dedupe`
- **Governance:** this directory in `C:\dev\dedupe\conductor\`
- **Plan-of-record reference:** `C:\dev\Dedupe-plan.md` → Series B / track 0023
...
Shingle/simhash/minhash near-dup clusters on extracted text.
