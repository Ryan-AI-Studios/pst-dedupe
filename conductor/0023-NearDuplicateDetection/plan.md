# 0023 — Near-duplicate detection — Plan

Phased checklist. Map phases to DoD items in `spec.md` §7. Execute in `C:\dev\dedupe`.

> **Ledger:** `ledgerful ledger start 0023-nearduplicatedetection --category FEATURE --message "Near-duplicate detection"` — commit in Finalize.
