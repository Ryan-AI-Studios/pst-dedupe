# 0018 — PST extractor adapter (wrap pst-reader) — Plan

Phased checklist. Map phases to DoD items in `spec.md` §7. Execute in `C:\dev\dedupe`.

> **Ledger:** `ledgerful ledger start 0018-pstextractoradapter --category FEATURE --message "PST extractor adapter (wrap pst-reader)"` — commit in Finalize.

---

## Phase 0 — Preconditions → DoD-3 baseline
- [ ] Confirm dependency tracks complete or document allowed parallel work: **0016,0017**
- [ ] Read `C:\dev\Dedupe-plan.md` sections for Series A
