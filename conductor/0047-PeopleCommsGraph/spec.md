# 0047 — People–comms graph + timeline

- **Track ID:** 0047-PeopleCommsGraph
- **Execution repo:** `C:\dev\dedupe`
- **Governance:** this directory in `C:\dev\dedupe\conductor\`
- **Plan-of-record reference:** `C:\dev\Dedupe-plan.md` → Series G / track 0047
...
- **P1 (blocking):** Dependencies: **0022,0046**
