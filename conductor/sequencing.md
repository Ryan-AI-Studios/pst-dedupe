...
| 4 | **0102** ExportOracleInputsAttest | **In progress** — remove recursive `"inputs"` strip; keep root `/inputs` blanking; 0099 pointers actually compare; D-0099-oracle-inputs-attest |
