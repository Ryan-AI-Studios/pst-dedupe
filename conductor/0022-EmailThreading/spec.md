# 0022 — Email threading

- **Track ID:** 0022-EmailThreading
- **Execution repo:** `C:\dev\dedupe`
- **Governance:** this directory in `C:\dev\dedupe\conductor\`
- **Plan-of-record reference:** `C:\dev\Dedupe-plan.md` → Series B / track 0022
...
Assign thread_id via Message-ID / In-Reply-To / References + subject fallback.
