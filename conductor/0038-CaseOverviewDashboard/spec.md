# 0038 — Case overview dashboard

- **Track ID:** 0038-CaseOverviewDashboard
- **Execution repo:** `C:\dev\dedupe`
- **Governance:** this directory in `C:\dev\dedupe\conductor\`
- **Plan-of-record reference:** `C:\dev\Dedupe-plan.md` → Series E / track 0038
...
Live counts, custodians, types, status during/after process.
...
- **P1 (blocking):** Dependencies: **0019,0025**
