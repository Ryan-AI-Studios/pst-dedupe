# 0035 — Calendar item support

- **Track ID:** 0035-CalendarItems
- **Execution repo:** `C:\dev\dedupe`
- **Governance:** this directory in `C:\dev\dedupe\conductor\`
- **Plan-of-record reference:** `C:\dev\Dedupe-plan.md` → Series D / track 0035
...
Map PST/ICS calendar invites into Normalized Items.
