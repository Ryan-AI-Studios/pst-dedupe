# 0024 — Cull filters + data reduction presets

- **Track ID:** 0024-CullAndReduce
- **Execution repo:** `C:\dev\dedupe`
- **Governance:** this directory in `C:\dev\dedupe\conductor\`
- **Plan-of-record reference:** `C:\dev\Dedupe-plan.md` → Series B / track 0024
...
Pre-review reduction: exact dups, empty, system noise, saved cull presets.
...
1. Deliver the capability summarized in §1 for Series B.
