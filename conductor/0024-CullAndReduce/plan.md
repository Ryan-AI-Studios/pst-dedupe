# 0024 — Cull filters + data reduction presets — Plan

Phased checklist. Map phases to DoD items in `spec.md` §7. Execute in `C:\dev\dedupe`.

> **Ledger:** `ledgerful ledger start 0024-cullandreduce --category FEATURE --message "Cull filters + data reduction presets"` — commit in Finalize.

---

## Phase 0 — Preconditions → DoD-3 baseline
- [ ] Confirm dependency tracks complete or document allowed parallel work: **0021**
- [ ] Read `C:\dev\Dedupe-plan.md` sections for Series B
