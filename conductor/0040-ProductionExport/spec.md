# 0040 — Production export (load file + natives)

- **Track ID:** 0040-ProductionExport
- **Execution repo:** `C:\dev\dedupe`
- **Governance:** this directory in `C:\dev\dedupe\conductor\`
- **Plan-of-record reference:** `C:\dev\Dedupe-plan.md` → Series E / track 0040
...
Court/regulatory review set: natives + load file starter.
...
- **P1 (blocking):** Dependencies: **0025,0032**
