# 0060 — Multi-jurisdiction production profiles — Plan

Phased checklist. Map phases to DoD items in `spec.md` §7. Execute in `C:\dev\dedupe`.

> **Ledger:** `ledgerful ledger start 0060-multijurisdictionproduction --category FEATURE --message "Multi-jurisdiction production profiles"` — commit in Finalize.

---

## Phase 0 — Preconditions → DoD-3 baseline
- [ ] Confirm dependency tracks complete or document allowed parallel work: **0041**
- [ ] Read `C:\dev\Dedupe-plan.md` sections for Series I
