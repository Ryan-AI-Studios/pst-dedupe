...
- **Track ID:** 0060-MultiJurisdictionProduction
- **Execution repo:** `C:\dev\dedupe`
- **Governance:** this directory in `C:\dev\dedupe\conductor\`
- **Plan-of-record reference:** `C:\dev\Dedupe-plan.md` → Series I / track 0060
...
Production profile packs for jurisdictions.
