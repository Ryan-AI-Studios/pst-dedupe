# 0044 — Workflow engine (Rampiva-style)

- **Track ID:** 0044-WorkflowEngine
- **Execution repo:** `C:\dev\dedupe`
- **Governance:** this directory in `C:\dev\dedupe\conductor\`
- **Plan-of-record reference:** `C:\dev\Dedupe-plan.md` → Series F / track 0044
...
Declarative ingest→reduce→promote→produce graphs.
...
1. Deliver the capability summarized in §1 for Series F.
...
| Risk | Mitigation |
|---|---|
| Scope creep into full Nuix parity | Stick to Series F outcome; defer via Proposed tracks |
...
- [ ] **DoD-1 — Capability:** The Series F outcome for this track is implemented and exercisable on Windows without manual server setup.
