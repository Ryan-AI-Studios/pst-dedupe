# 0044 — Workflow engine (Rampiva-style) — Plan

Phased checklist. Map phases to DoD items in `spec.md` §7. Execute in `C:\dev\dedupe`.

> **Ledger:** `ledgerful ledger start 0044-workflowengine --category FEATURE --message "Workflow engine (Rampiva-style)"` — commit in Finalize.

---

## Phase 0 — Preconditions → DoD-3 baseline
- [ ] Confirm dependency tracks complete or document allowed parallel work: **0043**
- [ ] Read `C:\dev\Dedupe-plan.md` sections for Series F
