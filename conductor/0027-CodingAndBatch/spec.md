# 0027 — Coding/tags + batch code

- **Track ID:** 0027-CodingAndBatch
- **Execution repo:** `C:\dev\dedupe`
- **Governance:** this directory in `C:\dev\dedupe\conductor\`
- **Plan-of-record reference:** `C:\dev\Dedupe-plan.md` → Series C / track 0027
...
Issue codes, tags, batch apply; audit each coding event.
