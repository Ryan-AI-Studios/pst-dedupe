# 0028 — Filters + saved searches

- **Track ID:** 0028-FiltersSavedSearch
- **Execution repo:** `C:\dev\dedupe`
- **Governance:** this directory in `C:\dev\dedupe\conductor\`
- **Plan-of-record reference:** `C:\dev\Dedupe-plan.md` → Series C / track 0028
...
Metadata filter builder and named saved searches.
