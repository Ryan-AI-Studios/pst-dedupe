# 0028 — Filters + saved searches — Plan

Phased checklist. Map phases to DoD items in `spec.md` §7. Execute in `C:\dev\dedupe`.

> **Ledger:** `ledgerful ledger start 0028-filterssavedsearch --category FEATURE --message "Filters + saved searches"` — commit in Finalize.

---

## Phase 0 — Preconditions → DoD-3 baseline
- [ ] Confirm dependency tracks complete or document allowed parallel work: **0026**
