# 0057 — Security hardener (encryption at rest) — Plan

Phased checklist. Map phases to DoD items in `spec.md` §7. Execute in `C:\dev\dedupe`.

> **Ledger:** `ledgerful ledger start 0057-securityhardener --category FEATURE --message "Security hardener (encryption at rest)"` — commit in Finalize.
