# 0042 — Gap analysis (custodians / opposing prod) — Plan

Phased checklist. Map phases to DoD items in `spec.md` §7. Execute in `C:\dev\dedupe`.

> **Ledger:** `ledgerful ledger start 0042-gapanalysis --category FEATURE --message "Gap analysis (custodians / opposing prod)"` — commit in Finalize.

---

## Phase 0 — Preconditions → DoD-3 baseline
- [ ] Confirm dependency tracks complete or document allowed parallel work: **0016,0040**
