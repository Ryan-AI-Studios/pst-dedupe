# 0031 — Privilege workflow + privilege log

- **Track ID:** 0031-PrivilegeWorkflow
- **Execution repo:** `C:\dev\dedupe`
- **Governance:** this directory in `C:\dev\dedupe\conductor\`
- **Plan-of-record reference:** `C:\dev\Dedupe-plan.md` → Series C / track 0031
...
Privilege holds, log export, production blocks.
