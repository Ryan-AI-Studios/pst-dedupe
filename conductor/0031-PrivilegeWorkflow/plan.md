# 0031 — Privilege workflow + privilege log — Plan

Phased checklist. Map phases to DoD items in `spec.md` §7. Execute in `C:\dev\dedupe`.

> **Ledger:** `ledgerful ledger start 0031-privilegeworkflow --category FEATURE --message "Privilege workflow + privilege log"` — commit in Finalize.

---

## Phase 0 — Preconditions → DoD-3 baseline
- [ ] Confirm dependency tracks complete or document allowed parallel work: **0027**
- [ ] Read `C:\dev\Dedupe-plan.md` sections for Series C
