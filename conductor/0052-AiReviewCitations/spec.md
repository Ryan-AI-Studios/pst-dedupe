# 0052 — AI review citations + human promote

- **Track ID:** 0052-AiReviewCitations
- **Execution repo:** `C:\dev\dedupe`
- **Governance:** this directory in `C:\dev\dedupe\conductor\`
- **Plan-of-record reference:** `C:\dev\Dedupe-plan.md` → Series G / track 0052
...
Defensible AI assist with citations and human promotion.
...
1. Deliver the capability summarized in §1 for Series G.
...
| Risk | Mitigation |
|---|---|
| Scope creep into full Nuix parity | Stick to Series G outcome; defer via Proposed tracks |
...
- [ ] **DoD-1 — Capability:** The Series G outcome for this track is implemented and exercisable on Windows without manual server setup.
