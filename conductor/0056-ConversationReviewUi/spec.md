# 0056 — Conversation-centric review UI

- **Track ID:** 0056-ConversationReviewUi
- **Execution repo:** `C:\dev\dedupe`
- **Governance:** this directory in `C:\dev\dedupe\conductor\`
- **Plan-of-record reference:** `C:\dev\Dedupe-plan.md` → Series H / track 0056
...
Chat-style review surface for Teams threads.
...
1. Deliver the capability summarized in §1 for Series H.
...
| Risk | Mitigation |
|---|---|
| Scope creep into full Nuix parity | Stick to Series H outcome; defer via Proposed tracks |
...
- [ ] **DoD-1 — Capability:** The Series H outcome for this track is implemented and exercisable on Windows without manual server setup.
