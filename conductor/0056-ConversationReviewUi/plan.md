# 0056 — Conversation-centric review UI — Plan

Phased checklist. Map phases to DoD items in `spec.md` §7. Execute in `C:\dev\dedupe`.

> **Ledger:** `ledgerful ledger start 0056-conversationreviewui --category FEATURE --message "Conversation-centric review UI"` — commit in Finalize.

---

## Phase 0 — Preconditions → DoD-3 baseline
- [ ] Confirm dependency tracks complete or document allowed parallel work: **0055**
- [ ] Read `C:\dev\Dedupe-plan.md` sections for Series H
