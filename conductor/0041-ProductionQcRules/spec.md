# 0041 — Production QC rules

- **Track ID:** 0041-ProductionQcRules
- **Execution repo:** `C:\dev\dedupe`
- **Governance:** this directory in `C:\dev\dedupe\conductor\`
- **Plan-of-record reference:** `C:\dev\Dedupe-plan.md` → Series E / track 0041
...
Configurable QC automation before produce.
