# 0033 — Office extractors (docx/xlsx/pptx)

- **Track ID:** 0033-OfficeExtractors
- **Execution repo:** `C:\dev\dedupe`
- **Governance:** this directory in `C:\dev\dedupe\conductor\`
- **Plan-of-record reference:** `C:\dev\Dedupe-plan.md` → Series D / track 0033
...
Extract text from Office Open XML for search/review.
