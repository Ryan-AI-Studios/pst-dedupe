# 0033 — Office extractors (docx/xlsx/pptx) — Plan

Phased checklist. Map phases to DoD items in `spec.md` §7. Execute in `C:\dev\dedupe`.

> **Ledger:** `ledgerful ledger start 0033-officeextractors --category FEATURE --message "Office extractors (docx/xlsx/pptx)"` — commit in Finalize.

---

## Phase 0 — Preconditions → DoD-3 baseline
- [ ] Confirm dependency tracks complete or document allowed parallel work: **0017**
- [ ] Read `C:\dev\Dedupe-plan.md` sections for Series D
