# 0055 — Teams/chat export adapters — Plan

Phased checklist. Map phases to DoD items in `spec.md` §7. Execute in `C:\dev\dedupe`.

> **Ledger:** `ledgerful ledger start 0055-teamschatadapters --category FEATURE --message "Teams/chat export adapters"` — commit in Finalize.
