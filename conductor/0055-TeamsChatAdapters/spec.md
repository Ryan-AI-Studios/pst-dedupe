# 0055 — Teams/chat export adapters

- **Track ID:** 0055-TeamsChatAdapters
- **Execution repo:** `C:\dev\dedupe`
- **Governance:** this directory in `C:\dev\dedupe\conductor\`
- **Plan-of-record reference:** `C:\dev\Dedupe-plan.md` → Series H / track 0055
...
Normalize Teams-derived content from Purview packages.
