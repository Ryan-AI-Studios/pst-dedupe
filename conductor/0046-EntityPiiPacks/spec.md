# 0046 — Entity / Data-Finder packs + PII

- **Track ID:** 0046-EntityPiiPacks
- **Execution repo:** `C:\dev\dedupe`
- **Governance:** this directory in `C:\dev\dedupe\conductor\`
- **Plan-of-record reference:** `C:\dev\Dedupe-plan.md` → Series G / track 0046
...
Regex identifier packs and PII flags.
