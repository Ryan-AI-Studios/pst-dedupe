# 0046 — Entity / Data-Finder packs + PII — Plan

Phased checklist. Map phases to DoD items in `spec.md` §7. Execute in `C:\dev\dedupe`.

> **Ledger:** `ledgerful ledger start 0046-entitypiipacks --category FEATURE --message "Entity / Data-Finder packs + PII"` — commit in Finalize.
