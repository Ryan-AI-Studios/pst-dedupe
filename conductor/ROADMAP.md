...
| **0125** | ProduceCanvas | **In progress** | **P3 T** | Un-wizard + protocol + Stage; 0119 latch frozen. Spec: `0125-ProduceCanvas/`. |
| **0126** | ProcessChromeVisual | **Proposed** | **P3 T** | Jobs table / minus-stack; 0122 stays. Spec: `0126-ProcessChromeVisual/`. |

**Order:** **0110** → **0111** → **0112** → **0113**; **0114** after window; **0115 Completed**; **0116 Completed**. **0117 Completed**. **0118 Completed**. **0119 Completed**. **0120 Completed**. **0121 Completed**. **0122 Completed**. **0123 Completed**. **Series T:** **0124 Completed**; **0125 In progress**; **0126** after shell.
