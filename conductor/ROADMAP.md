...
**Order:** **0110** → **0111** → **0112** → **0113**; **0114** after window; **0115 Completed**; **0116 Completed**. **0117 Completed**. **0118 Completed**. **0119 Completed**. **0120 Completed**. **0121 Completed**. **0122** can run after 0116 without blocking 0117. **Series T:** **0123** (Plex + navy; Home under bar) then **0124**; **0125** ∥ **0126** after shell.
