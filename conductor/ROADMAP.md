...
| **0122** | ProcessFoldResiduals | **Ready — not started** | **P3 O** | PR #123 Bugbot: extract-all Busy must not wipe queue; live job-row Pause from current progress. Not 0117. Spec: `0122-ProcessFoldResiduals/`. |
...
**Order:** **0110** → **0111** → **0112** → **0113**; **0114** after window; **0115 Completed**; **0116 Completed**. **0117 Completed**. **0118 Completed**. **0119 Completed**. **0120 Completed**. **0121 Completed**. **0122 In progress**. **Series T:** **0123** (Plex + navy; Home under bar) then **0124**; **0125** ∥ **0126** after shell.
