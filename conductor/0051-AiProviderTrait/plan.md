# 0051 — AI provider trait + first-pass suggestions — Plan

Phased checklist. Map phases to DoD items in `spec.md` §7. Execute in `C:\dev\dedupe`.

> **Ledger:** `ledgerful ledger start 0051-aiprovidertrait --category FEATURE --message "AI provider trait + first-pass suggestions"` — commit in Finalize.

---

## Phase 0 — Preconditions → DoD-3 baseline
- [ ] Confirm dependency tracks complete or document allowed parallel work: **0027**
- [ ] Read `C:\dev\Dedupe-plan.md` sections for Series G
