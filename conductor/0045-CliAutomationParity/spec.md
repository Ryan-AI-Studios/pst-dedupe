# 0045 — CLI automation parity

- **Track ID:** 0045-CliAutomationParity
- **Execution repo:** `C:\dev\dedupe`
- **Governance:** this directory in `C:\dev\dedupe\conductor\`
- **Plan-of-record reference:** `C:\dev\Dedupe-plan.md` → Series F / track 0045
...
Headless full matter runs via pst-dedup CLI.
