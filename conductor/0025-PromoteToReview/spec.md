# 0025 — Promote-to-review corpus

- **Track ID:** 0025-PromoteToReview
- **Execution repo:** `C:\dev\dedupe`
- **Governance:** this directory in `C:\dev\dedupe\conductor\`
- **Plan-of-record reference:** `C:\dev\Dedupe-plan.md` → Series B / track 0025
...
Explicit Review Corpus subset of matter items for linear review.
