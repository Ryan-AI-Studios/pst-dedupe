# 0043 — Processing profiles

- **Track ID:** 0043-ProcessingProfiles
- **Execution repo:** `C:\dev\dedupe`
- **Governance:** this directory in `C:\dev\dedupe\conductor\`
- **Plan-of-record reference:** `C:\dev\Dedupe-plan.md` → Series F / track 0043
...
Saved OCR/dedupe/filter profiles.
...
- **P1 (blocking):** Dependencies: **0019,0024**
