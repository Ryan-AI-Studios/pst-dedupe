# 0036 — OCR plugin (optional local)

- **Track ID:** 0036-OcrPlugin
- **Execution repo:** `C:\dev\dedupe`
- **Governance:** this directory in `C:\dev\dedupe\conductor\`
- **Plan-of-record reference:** `C:\dev\Dedupe-plan.md` → Series D / track 0036
...
Optional local OCR (no always-on server) for scans/images.
