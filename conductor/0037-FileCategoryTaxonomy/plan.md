# 0037 — File category taxonomy — Plan

Phased checklist. Map phases to DoD items in `spec.md` §7. Execute in `C:\dev\dedupe`.

> **Ledger:** `ledgerful ledger start 0037-filecategorytaxonomy --category FEATURE --message "File category taxonomy"` — commit in Finalize.
