# 0037 — File category taxonomy

- **Track ID:** 0037-FileCategoryTaxonomy
- **Execution repo:** `C:\dev\dedupe`
- **Governance:** this directory in `C:\dev\dedupe\conductor\`
- **Plan-of-record reference:** `C:\dev\Dedupe-plan.md` → Series D / track 0037
...
Workstation-like categories: email, containers, db, logs, media, mobile, cloud.
...
1. Deliver the capability summarized in §1 for Series D.
...
| Risk | Mitigation |
|---|---|
| Scope creep into full Nuix parity | Stick to Series D outcome; defer via Proposed tracks |
...
- [ ] **DoD-1 — Capability:** The Series D outcome for this track is implemented and exercisable on Windows without manual server setup.
