# 0026 — Review list + email viewer

- **Track ID:** 0026-ReviewListViewer
- **Execution repo:** `C:\dev\dedupe`
- **Governance:** this directory in `C:\dev\dedupe\conductor\`
- **Plan-of-record reference:** `C:\dev\Dedupe-plan.md` → Series C / track 0026
...
Linear review UI: list, open email/body, navigate attachments.
...
1. Deliver the capability summarized in §1 for Series C.
